  ...
  formChange = (e) => {
    ...
    if (e.target.name === 'website' || e.target.name === 'instagarm' || e.target.name === 'facebook' || e.target.name === 'github' || e.target.name === 'twitter' || e.target.name === 'discord' || e.target.name === 'youtube' || e.target.name === 'twitch' || e.target.name === 'tiktok' || e.target.name === 'snapchat') {
      if (userObj.portfolio) {
        this.setState({ userObj: { ...userObj, 'portfolio': { ...userObj.portfolio, [e.target.name]: { ...userObj.portfolio[e.target.name], 'url': e.target.value } } } })
      } else {
        this.setState({ userObj: { ...userObj, 'portfolio': { [e.target.name]: e.target.value } } })
      }
    } else {
                      ...
                      <NFTForm>
                        ...
                        <div className="iLeft">
                          ...
                          <input
                            ...
                            placeholder="Type something…"
                            onKeyPress={(e) => { if (e.key === 'Enter') {e.preventDefault()} }}
                            defaultValue={profile ? profile.portfolio?.website ? profile.portfolio.website.url : '' : ''}
                          />
                        </div>
                      </NFTForm>
                      <NFTForm>
                        ...
                        <div className="iLeft">
                          ...
                          <input
                            ...
                            placeholder="Type something…"
                            onKeyPress={(e) => { if (e.key === 'Enter') {e.preventDefault()} }}
                            defaultValue={profile ? profile.portfolio?.instagarm ? profile.portfolio.instagarm.url : '' : ''}
                          />
                        </div>
                      </NFTForm>
                      <NFTForm>
                        ...
                        <div className="iLeft">
                          ...
                          <input
                            ...
                            placeholder="Type something…"
                            onKeyPress={(e) => { if (e.key === 'Enter') {e.preventDefault()} }}
                            defaultValue={profile ? profile.portfolio?.discord ? profile.portfolio.discord.url : '' : ''}
                          />
                        </div>
                      </NFTForm>
                      <NFTForm>
                        ...
                        <div className="iLeft">
                          ...
                          <input
                            ...
                            placeholder="Type something…"
                            onKeyPress={(e) => { if (e.key === 'Enter') {e.preventDefault()} }}
                            defaultValue={profile ? profile.portfolio?.youtube ? profile.portfolio.youtube.url : '' : ''}
                          />
                        </div>
                      </NFTForm>
                      <NFTForm>
                        ...
                        <div className="iLeft">
                          ...
                          <input
                            ...
                            placeholder="Type something…"
                            onKeyPress={(e) => { if (e.key === 'Enter') {e.preventDefault()} }}
                            defaultValue={profile ? profile.portfolio?.facebook ? profile.portfolio.facebook.url : '' : ''}
                          />
                        </div>
                      </NFTForm>
                      <CreateItemButton>
