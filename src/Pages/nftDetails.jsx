...
class NftDetail extends React.Component {
  ...
  getEditionNumber = (NFTDetails, currentEdition) => {
    ...
    console.log("get edition number", NFTDetails);
  ...
  render() {
    ...
    console.log("this is current price", +selectedNFTDetails?.price);
