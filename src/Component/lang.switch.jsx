...
const Language = (props) => {
    ...
    const LanBTN = styled(FlexDiv)`  
        ...
        ${Media.md}{
            position:absolute; right:60px; left:auto; top:0px;
            .app__collapse{opacity:1; overflow:visible !important; visibility:visible !important; height:auto !important;}
        } 
    `
    const DDContainer = styled(FlexDiv)` 
        ...
        ${Media.md}{
            box-shadow:none; width:max-content; padding:0px;
        } 
    `
    const DDBtnbar01 = styled(FlexDiv)`
        font-size:16px; color:#B3B3B3; font-weight: 600; 
        button{ font-size:16px; padding:0 10px; margin:0 6px; color:#B3B3B3; 
            &.active{color:#000;} :hover{color:#000;} 
            ${Media.md}{
                font-size:18px;
            } 
        } 
